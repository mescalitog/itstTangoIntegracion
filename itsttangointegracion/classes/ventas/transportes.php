...
class Transportes
{
    ...
    {
        $transportes = \TangoApi::instance()->ventasGetTransportes();
        return $transportes;
    }

    public static function getTransporte($cod_transp)
    {
        $transporte = \TangoApi::instance()->ventasGetTransporte($cod_transp);
        return $transporte;
    }
