...
class ItstConfigFormsCustomers extends ItstConfigForms
{
    ...
    protected static function getFormFields()
    {
        ...
        $cron_info = '<h4>' . self::$module->l('How to synchronize Customers') . '</h4>'
            . self::$module->l('Enable this feature to synchronize Customers');

        $cron_info_link = '<h4>' . self::$module->l('How to synchronize Customers') . '</h4>'
            . self::$module->l(
        ...
        $form = array(
            'form' => array(
                ...
                'input' => array(
                    array(
                        'type' => 'switch',
                        'label' => self::$module->l('Synchronize Customers', 'itsttangointegracion'),
                        'name' => Consts\ITST_TANGO_CUSTOMERS_SYNC,
                        'is_bool' => true,
                        'desc' => self::$module->l('Enable to sync customer data upon registration'),
                        'values' => array(
